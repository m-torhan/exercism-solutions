...
/**
 * preparationTime returns an estimate of the preparation time based on the number of layers and the necessary time per
 * layer.
 */
int preparationTime(int numberOfLayers) { return numberOfLayers << 1; }
